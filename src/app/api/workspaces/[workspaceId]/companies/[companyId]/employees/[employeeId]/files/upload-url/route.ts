...
export async function POST(
  ...
  try {
    ...
    // The requester must have access to the company within the workspace
    ...
    const key = `employees/${employeeId}/${Date.now()}_${filename}`;
    ...
    console.error("Error generating employee upload URL:", error);
