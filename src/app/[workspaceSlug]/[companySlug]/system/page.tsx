...
export default function SystemPage() {
  ...
  const createModuleMutation = useMutation({
    ...
    onError: (error: any) => {
      toast.error(error.message || "Modül oluşturulurken hata oluştu");
    }
  });
  ...
  const createResourceMutation = useMutation({
    ...
    onError: (error: any) => {
      toast.error(error.message || "Kaynak oluşturulurken hata oluştu");
    }
  });
  ...
  const createPermissionMutation = useMutation({
    ...
    onError: (error: any) => {
      toast.error(error.message || "İzin oluşturulurken hata oluştu");
    }
  });
